...
public class PenlderRatDBonusIIPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "PenlderRatDBonusII";
	...
	private PenlderRatDBonusIIPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PenlderRatDBonusIIPersistentManager();
		}
